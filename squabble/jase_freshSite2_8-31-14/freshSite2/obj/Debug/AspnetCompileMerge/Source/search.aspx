            ...
            <section id="searchForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                           <asp:DropDownList ID="UniversityList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="UniversityList_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                           <asp:DropDownList ID="TermList" runat="server" OnSelectedIndexChanged="TermList_SelectedIndexChanged" Enabled="False" AutoPostBack="True"></asp:DropDownList>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-10">
                           <asp:DropDownList ID="DepartmentList" runat="server" OnSelectedIndexChanged="DepartmentList_SelectedIndexChanged" AutoPostBack="True" Enabled="False"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                           <asp:DropDownList ID="CourseList" runat="server" OnSelectedIndexChanged="CourseList_SelectedIndexChanged" Enabled="False" AutoPostBack="True"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                           <asp:DropDownList ID="SectionList" runat="server" OnSelectedIndexChanged="SectionList_SelectedIndexChanged" AutoPostBack="True" Enabled="False"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                           <asp:DropDownList ID="BookList" runat="server" OnSelectedIndexChanged="BookList_SelectedIndexChanged" Enabled="False"></asp:DropDownList>
